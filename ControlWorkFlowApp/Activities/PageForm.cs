...
namespace ControlWorkFlowApp
{
    public class PageForm : Form
    {
        private void InitializeComponent()
        {
            ...
            // activityPanel
            // 
            this.activityPanel.BorderStyle = BorderStyle.FixedSingle;
            this.activityPanel.Dock = DockStyle.Fill;
            ...
            this.pagePanel.BorderStyle = BorderStyle.FixedSingle;
            ...
            this.tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 250F));
            ...
            this.Load += new EventHandler(this.PageForm_Load);
        ...
        private string Title = "ControlFlow ";
